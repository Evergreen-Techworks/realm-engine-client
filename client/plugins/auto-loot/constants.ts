...
// Keep the swap well inside the server's interaction radius. A radius of one
// allowed fast movement to clip the edge of a bag and send INVENTORYSWAP before
